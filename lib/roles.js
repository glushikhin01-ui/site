...
const PERMISSION_GROUPS = [
  {
    key: "view",
    title: "Просмотр",
    perms: ["view_players", "view_profile", "view_bans", "view_stats", "view_blacklist", "view_admin_logs", "view_money_logs", "view_donate_logs", "view_player_donate"]
  },
  {
    key: "actions",
    title: "Действия с игроками",
    perms: ["kick", "ban", "unban", "adminmode", "give_money", "set_rank", "manage_player_donate"]
  },
  {
    key: "content",
    title: "Контент и ЧСП",
...
const PERMISSION_LABELS = {
  ...
  view_money_logs: "Тех.раздел: деньги и банды",
...
function defaultPermissions() {
  ...
  return {
    KP: { ...allTrue },
    "Управляющий": { ...allTrue, manage_permissions: false, manage_zbt_access: false, manage_users: false, view_blacklist: false, manage_blacklist: false, raw_console: false },
    "Команда Проекта": {
